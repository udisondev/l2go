...
Каталог артефакта статики для embed-транспорта. Файл `artifact.l2a` —
производная данных датапака и геодаты (байты, полученные из игровых данных),
в git он не коммитится и создаётся сборкой.

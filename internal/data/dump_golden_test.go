...
terr name="start_terr" minZ=-3600 maxZ=-2800 nodes=[-72000,257000 -70000,257000 -70000,259000] banned=[] sets=[]
...
spawn npc=30080 point=-70000,258000,-3104,16384 terr="" count=1 respawn=60 sets=[]
spawn npc=20550 point=-70800,259000,-3104,-1 terr="" count=2 respawn=60 sets=[]
spawn npc=20551 point=- terr="start_terr" count=3 respawn=22 sets=[]
spawn npc=20550 point=150000,10000,-3000,-1 terr="" count=1 respawn=60 sets=[]
